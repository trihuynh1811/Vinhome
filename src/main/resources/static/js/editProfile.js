...
const uploadPfpBtnLoading = document.querySelector('.loading')
...
const saveLoading = submitBtn.querySelector('.loading')
...
//     uploadPfpBtnLoading.classList.toggle('hidden')
//     console.log(uploadFile.value)
//     console.log(uploadFile.files.length)
//     //AXIOS POST REQUEST//
...
//         }
//         else {
//           alert("Fail update profile picture")
//         }
//       })
//       .catch((err) => {
//         console.log(err)
...
profileForm.addEventListener('submit', async (e) => {
  ...
  saveLoading.classList.toggle('hidden')
